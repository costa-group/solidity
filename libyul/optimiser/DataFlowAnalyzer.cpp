...
void DataFlowAnalyzer::operator()(FunctionDefinition& _fun)
{
	...
	SetValueForCurrentScope valueResetter(m_value, {});
	SetValueForCurrentScope loopDepthResetter(m_loopDepth, 0u);
	SetValueForCurrentScope referencesResetter(m_references, {});
	SetValueForCurrentScope storageResetter(m_storage, {});
	SetValueForCurrentScope memoryResetter(m_memory, {});
	pushScope(true);
